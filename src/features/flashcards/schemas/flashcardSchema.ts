...
export const mapFlashcardSetToFormValues = (set?: { title?: string; description?: string; visibility?: 'global' | 'private'; code?: string; shuffleCards?: boolean; folderId?: string }) => ({
  title: set?.title || '',
