...
import { getLocalFlashcardSets, getFlashcardSetById, saveFlashcardSetToLocal } from '@flashcardData'
...
import type { FlashcardSet, Flashcard } from '@shared/types'
    ...
    const load = async () => {
      ...
      if (!found && hasFirebaseConfig) {
        try {
          ...
          logError(error, 'FlashcardStudy:load')
        }
      }
