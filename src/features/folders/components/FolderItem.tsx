...
const visibilityIcon = (v: FolderType["visibility"]) => {
  switch (v) {
    ...
    case "code":
      return <KeyRound size={12} className="text-yellow-400" />;
    default:
...
export const FolderItem = ({
  ...
  onDelete,
  onUpdateVisibility,
}: Omit<FolderItemProps, "id" | "createdBy">) => {
  ...
  return (
    ...
    >
        ...
        <>
          ...
          {isOwn && (
            <div className="hidden group-hover:flex gap-0.5">
              <button
                ...
                className="p-1 hover:text-white text-xs"
          ...
          {visibility === "code" && code && (
            <button
              ...
              className="text-xs font-mono tracking-wider text-yellow-400/70 hover:text-yellow-300 flex items-center gap-1"
              title="Copiar código"
            >
      ...
      {showVisMenu && isOwn && (
        <div
          className="absolute top-full left-0 right-0 z-20 mt-1 bg-gray-900 border border-gray-700 rounded-lg p-2 shadow-xl"
